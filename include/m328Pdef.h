...
#define IO_ADDR(port) (&port - (volatile uint8_t *)IO_BASE)
...
#define UDR0    (*(volatile uint8_t *)0xc6)  // MEMORY MAPPED
#define UBRR0L  (*(volatile uint8_t *)0xc4)  // MEMORY MAPPED
#define UBRR0H  (*(volatile uint8_t *)0xc5)  // MEMORY MAPPED
#define UCSR0C  (*(volatile uint8_t *)0xc2)  // MEMORY MAPPED
#define UCSR0B  (*(volatile uint8_t *)0xc1)  // MEMORY MAPPED
#define UCSR0A  (*(volatile uint8_t *)0xc0)  // MEMORY MAPPED
#define TWAMR   (*(volatile uint8_t *)0xbd)  // MEMORY MAPPED
#define TWCR    (*(volatile uint8_t *)0xbc)  // MEMORY MAPPED
#define TWDR    (*(volatile uint8_t *)0xbb)  // MEMORY MAPPED
#define TWAR    (*(volatile uint8_t *)0xba)  // MEMORY MAPPED
#define TWSR    (*(volatile uint8_t *)0xb9)  // MEMORY MAPPED
#define TWBR    (*(volatile uint8_t *)0xb8)  // MEMORY MAPPED
#define ASSR    (*(volatile uint8_t *)0xb6)  // MEMORY MAPPED
#define OCR2B   (*(volatile uint8_t *)0xb4)  // MEMORY MAPPED
#define OCR2A   (*(volatile uint8_t *)0xb3)  // MEMORY MAPPED
#define TCNT2   (*(volatile uint8_t *)0xb2)  // MEMORY MAPPED
#define TCCR2B  (*(volatile uint8_t *)0xb1)  // MEMORY MAPPED
#define TCCR2A  (*(volatile uint8_t *)0xb0)  // MEMORY MAPPED
#define OCR1BL  (*(volatile uint8_t *)0x8a)  // MEMORY MAPPED
#define OCR1BH  (*(volatile uint8_t *)0x8b)  // MEMORY MAPPED
#define OCR1AL  (*(volatile uint8_t *)0x88)  // MEMORY MAPPED
#define OCR1AH  (*(volatile uint8_t *)0x89)  // MEMORY MAPPED
#define ICR1L   (*(volatile uint8_t *)0x86)  // MEMORY MAPPED
#define ICR1H   (*(volatile uint8_t *)0x87)  // MEMORY MAPPED
#define TCNT1L  (*(volatile uint8_t *)0x84)  // MEMORY MAPPED
#define TCNT1H  (*(volatile uint8_t *)0x85)  // MEMORY MAPPED
#define TCCR1C  (*(volatile uint8_t *)0x82)  // MEMORY MAPPED
#define TCCR1B  (*(volatile uint8_t *)0x81)  // MEMORY MAPPED
#define TCCR1A  (*(volatile uint8_t *)0x80)  // MEMORY MAPPED
#define DIDR1   (*(volatile uint8_t *)0x7f)  // MEMORY MAPPED
#define DIDR0   (*(volatile uint8_t *)0x7e)  // MEMORY MAPPED
#define ADMUX   (*(volatile uint8_t *)0x7c)  // MEMORY MAPPED
#define ADCSRB  (*(volatile uint8_t *)0x7b)  // MEMORY MAPPED
#define ADCSRA  (*(volatile uint8_t *)0x7a)  // MEMORY MAPPED
#define ADCH    (*(volatile uint8_t *)0x79)  // MEMORY MAPPED
#define ADCL    (*(volatile uint8_t *)0x78)  // MEMORY MAPPED
#define TIMSK2  (*(volatile uint8_t *)0x70)  // MEMORY MAPPED
#define TIMSK1  (*(volatile uint8_t *)0x6f)  // MEMORY MAPPED
#define TIMSK0  (*(volatile uint8_t *)0x6e)  // MEMORY MAPPED
#define PCMSK1  (*(volatile uint8_t *)0x6c)  // MEMORY MAPPED
#define PCMSK2  (*(volatile uint8_t *)0x6d)  // MEMORY MAPPED
#define PCMSK0  (*(volatile uint8_t *)0x6b)  // MEMORY MAPPED
#define EICRA   (*(volatile uint8_t *)0x69)  // MEMORY MAPPED
#define PCICR   (*(volatile uint8_t *)0x68)  // MEMORY MAPPED
#define OSCCAL  (*(volatile uint8_t *)0x66)  // MEMORY MAPPED
#define PRR     (*(volatile uint8_t *)0x64)  // MEMORY MAPPED
#define CLKPR   (*(volatile uint8_t *)0x61)  // MEMORY MAPPED
#define WDTCSR  (*(volatile uint8_t *)0x60)  // MEMORY MAPPED
#define SREG    (*(volatile uint8_t *)(IO_BASE + 0x3f))
#define SPL     (*(volatile uint8_t *)(IO_BASE + 0x3d))
#define SPH     (*(volatile uint8_t *)(IO_BASE + 0x3e))
#define SPMCSR  (*(volatile uint8_t *)(IO_BASE + 0x37))
#define MCUCR   (*(volatile uint8_t *)(IO_BASE + 0x35))
#define MCUSR   (*(volatile uint8_t *)(IO_BASE + 0x34))
#define SMCR    (*(volatile uint8_t *)(IO_BASE + 0x33))
#define ACSR    (*(volatile uint8_t *)(IO_BASE + 0x30))
#define SPDR    (*(volatile uint8_t *)(IO_BASE + 0x2e))
#define SPSR    (*(volatile uint8_t *)(IO_BASE + 0x2d))
#define SPCR    (*(volatile uint8_t *)(IO_BASE + 0x2c))
#define GPIOR2  (*(volatile uint8_t *)(IO_BASE + 0x2b))
#define GPIOR1  (*(volatile uint8_t *)(IO_BASE + 0x2a))
#define OCR0B   (*(volatile uint8_t *)(IO_BASE + 0x28))
#define OCR0A   (*(volatile uint8_t *)(IO_BASE + 0x27))
#define TCNT0   (*(volatile uint8_t *)(IO_BASE + 0x26))
#define TCCR0B  (*(volatile uint8_t *)(IO_BASE + 0x25))
#define TCCR0A  (*(volatile uint8_t *)(IO_BASE + 0x24))
#define GTCCR   (*(volatile uint8_t *)(IO_BASE + 0x23))
#define EEARH   (*(volatile uint8_t *)(IO_BASE + 0x22))
#define EEARL   (*(volatile uint8_t *)(IO_BASE + 0x21))
#define EEDR    (*(volatile uint8_t *)(IO_BASE + 0x20))
#define EECR    (*(volatile uint8_t *)(IO_BASE + 0x1f))
#define GPIOR0  (*(volatile uint8_t *)(IO_BASE + 0x1e))
#define EIMSK   (*(volatile uint8_t *)(IO_BASE + 0x1d))
#define EIFR    (*(volatile uint8_t *)(IO_BASE + 0x1c))
#define PCIFR   (*(volatile uint8_t *)(IO_BASE + 0x1b))
#define TIFR2   (*(volatile uint8_t *)(IO_BASE + 0x17))
#define TIFR1   (*(volatile uint8_t *)(IO_BASE + 0x16))
#define TIFR0   (*(volatile uint8_t *)(IO_BASE + 0x15))
#define PORTD   (*(volatile uint8_t *)(IO_BASE + 0x0b))
#define DDRD    (*(volatile uint8_t *)(IO_BASE + 0x0a))
#define PIND    (*(volatile uint8_t *)(IO_BASE + 0x09))
#define PORTC   (*(volatile uint8_t *)(IO_BASE + 0x08))
#define DDRC    (*(volatile uint8_t *)(IO_BASE + 0x07))
#define PINC    (*(volatile uint8_t *)(IO_BASE + 0x06))
#define PORTB   (*(volatile uint8_t *)(IO_BASE + 0x05))
#define DDRB    (*(volatile uint8_t *)(IO_BASE + 0x04))
#define PINB    (*(volatile uint8_t *)(IO_BASE + 0x03))
